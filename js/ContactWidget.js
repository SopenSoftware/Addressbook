Tine.Addressbook.ContactWidget = function(config) {
    Ext.apply(this, config);
    
    
    Tine.Addressbook.ContactWidget.superclass.constructor.call(this);
};

Ext.extend(Tine.Addressbook.ContactWidget, Ext.Panel, {
	...
	initComponent: function(){
		...
		Tine.Addressbook.ContactWidget.superclass.initComponent.call(this);
		this.contactEditDialog.on('loadcontact',this.onLoadContact,this);
	},
    /**
    ...
    initDropZone: function(){
		...
		this.dd = new Ext.dd.DropTarget(this.el, {
			...
			notifyDrop  : function(ddSource, e, data){
				var result = this.scope.contactEditDialog.onDrop(ddSource,e,data);
				var record = this.scope.contactEditDialog.extractRecordFromDrop(ddSource,e,data);
...
Ext.reg('contactwidget',Tine.Addressbook.ContactWidget);