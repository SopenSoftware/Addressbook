 ...
 * @version     $Id: Cli.php 10932 2009-10-13 10:13:07Z p.schuele@metaways.de $
 * 
 */
...
class Addressbook_Frontend_Cli extends Tinebase_Frontend_Cli_Abstract
{
    ...
    public function importPostalCodes($_opts){
    	set_time_limit(0);
        parent::_import($_opts, Addressbook_Controller_PostalCode::getInstance());    
    }
