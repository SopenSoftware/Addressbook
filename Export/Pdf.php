 ...
 * @version     $Id: Pdf.php 14553 2010-05-28 12:47:45Z f.wiechmann@metaways.de $
 */
...
class Addressbook_Export_Pdf extends Tinebase_Export_Pdf
{
    ...
    public function generate(Addressbook_Model_Contact $_contact)
    {
        ...
        //$titleIcon = CSopen::instance()->getCustomResourcePath('tine')."images/oxygen/32x32/apps/system-users.png";
        $titleIcon = null;
